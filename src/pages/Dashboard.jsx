...
export default function Dashboard() {
  ...
  /* -----------------------------------------------------------
     Prepare best-selling data
  ----------------------------------------------------------- */

  const bestSelling =
    (
      bestSellingData?.medicines ||
      []
    )
      .slice(
        0,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p>
            ...
            A quick view of today's pharmacy
            activity and stock health.
...

      {
        ...
        (
          ...
          >
            ...
            <div
              className="dashboard-alert-content"
            >
              ...
              : bestSellingError
                ...
                : bestSelling.length ===
                  ...
                  ? (
                      ...
                      <EmptyState
                        label="No medicine sales recorded yet."
                      />
              ...
              : inventoryError
                ...
                : stockHealth.length ===
                  ...
                  ? (
                      ...
                      <EmptyState
                        label="No inventory information available."
                      />
      ...
      >
        ...
        <section
          className="card dashboard-mini-card"
        >

          <div
            className="dashboard-mini-icon expiry"
          >
          ...
          <div>
            ...
            <div
              className="dashboard-mini-label"
            >
            ...
            <div
              className="dashboard-mini-value"
            >
        ...
        >
          ...
          <div
            className="dashboard-mini-icon sales"
          >
      ...
      <section
        className="card card-pad dashboard-sales-card"
      >
...
function RevenueDashboardCard({
  ...
  return (
    ...
    <div
      className={
        "stat-card dashboard-stat-card revenue-dashboard-card tone-success"
      }
    >
      ...
      <div
        className={
          "dashboard-card-icon success revenue-card-icon"
        }
      >
      ...
      <div
        className={
          "dashboard-card-content revenue-card-content"
        }
      >
        ...
        <div
          className="revenue-breakdown-row expense"
        >
        ...
        <div
          className="revenue-breakdown-line"
        />
        ...
        <div
          className="revenue-breakdown-row revenue-net"
        >
      ...
      <button
        ...
        className={
          "dashboard-card-action revenue-expense-button"
        }
  ...
  if (
    ...
    return (
      ...
      <Link
        ...
        className={
          `stat-card dashboard-stat-card tone-${
            tone ||
            "default"
          }`
        }
